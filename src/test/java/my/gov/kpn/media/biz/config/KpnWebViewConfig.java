...
public class KpnWebViewConfig {
    ...
    public static final String TEMPLATE_DIRECTORY_FORM = "fragments/form";
    public static final String TEMPLATE_DIRECTORY_GRID = "fragments/grid";
    public static final String TEMPLATE_ALIAS_COMMON = "common";
    public static final String TEMPLATE_ALIAS_COMPONENT = "component";
    public static final String TEMPLATE_ALIAS_FORM = "form";
    public static final String TEMPLATE_ALIAS_GRID = "grid";
    ...
    public TemplateResolver templateResolver() {
        ...
        templateResolver.addTemplateAlias(TEMPLATE_ALIAS_FORM, TEMPLATE_DIRECTORY_FORM);
        templateResolver.addTemplateAlias(TEMPLATE_ALIAS_GRID, TEMPLATE_DIRECTORY_GRID);
